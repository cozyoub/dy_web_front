...
const getNotiByCategoryService = (category) =>
  axiosInstance.get(`${BASE_URL}/category/${category}`);

const saveNotiService = (noti, file) => {
  const formData = new FormData();
  formData.append(
    "noti",
    new Blob([JSON.stringify(noti)], { type: "application/json" }),
  );
